...
alias ut='uaac target https://pks.corp.local:8443 --skip-ssl-validation'uaac target https://pks.corp.local:8443 --skip-ssl-validation'
...
echo "alias ut='uaac target https://pks.corp.local:8443 --skip-ssl-validation'uaac target https://pks.corp.local:8443 --skip-ssl-validation'" >> ~/.bashrc
else
